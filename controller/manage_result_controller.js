var manage_reslt = require('../model/add_result_model');

exports.delete_data = async(req,res) => {
    var id = req.params.id;

    var data = await manage_reslt.findByIdAndDelete(id);
...
exports.update_data = async(req,res) => {
    ...
    var data = await manage_reslt.findByIdAndUpdate(id,req.body);
    data['total'] = total;
    data['per'] = per;
    data['max'] = max;
    data['min'] = min;
